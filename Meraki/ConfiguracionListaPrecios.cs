...
namespace Meraki
{
    public partial class ConfiguracionListaPrecios : Form
    {
        ...
        public ConfiguracionListaPrecios()
        {
        ...
        private void ConfiguracionListaPrecios_Load(object sender, EventArgs e)
        {
        ...
        #region ⚡ Eventos de Selección y Doble Clic (Acción Inmediata)
        ...
        private void dataGridViewProductosAsignados_CellDoubleClick(object sender, DataGridViewCellEventArgs e)
        {
        ...
        private void dataGridViewProductosSinAsignar_CellDoubleClick(object sender, DataGridViewCellEventArgs e)
        {
            if (e.RowIndex < 0) return;
        ...
        #region ➕ - Botones de los Tipos (Alta y Baja Directa)

        private void iconButtonTipoAgregar_Click(object sender, EventArgs e)
        {
        ...
        private void iconButtonTipoQuitar_Click(object sender, EventArgs e)
        {
            if (dataGridViewTipos.CurrentRow != null && dataGridViewTipos.CurrentRow.DataBoundItem is BECategoriaPDF tipoSeleccionado)
            {
        ...
        private void textBoxFiltrarSinAsignar_TextChanged(object sender, EventArgs e)
        {
            FiltrarSinAsignar();
        }

        private void textBoxFiltrarAsignados_TextChanged(object sender, EventArgs e)
        {
            FiltrarAsignados();
        }

        private void iconButtonQuitarAsignado_Click(object sender, EventArgs e)
        {
